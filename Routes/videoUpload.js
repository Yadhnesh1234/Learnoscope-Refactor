...
const {UploadVideoData,moderationCallBack,getVideoData,getVideoList,deleteVideo}=require('../Controllers/videoUpload')
...
router.post("/upload-video",upload,UploadVideoData)
